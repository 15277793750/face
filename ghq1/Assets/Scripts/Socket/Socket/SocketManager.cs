...
public class SocketManager
{
    ...
    //public static T (byte[] param, Class<T> clazz)
    //{
    ...
    private void SendMsgBase(eProtocalCommand _protocalType, byte[] _data)
    {
        ...
        Debug.Log("发送消息的长度："+_msgdata.Length);
        Debug.Log("发送消息");
    ...
    /// <param name="_protocalType"></param>
    /// <param name="data"></param>
    public void SendMsg<T>(eProtocalCommand _protocalType, T data)
    {
        ...
        SendMsgBase(_protocalType, data1);
    }
    ...
    public void SendTestMsg()
    {
        ...
        byte[] _msgdata = Convert.FromBase64String("Hello");
        clientSocket.BeginSend(_msgdata, 0, _msgdata.Length, SocketFlags.None, new AsyncCallback(_onSendMsg), clientSocket);
    }
}